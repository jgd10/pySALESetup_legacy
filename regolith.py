...
meshC.top_and_tail()
meshC.viewMats()
meshC.save(fname='regolith_circles.iSALE',compress=True)
...
meshD.top_and_tail()
meshD.viewMats()
meshD.save(fname='regolith_tetrahedracritangle.iSALE',compress=True)
meshA.fillAll(-1)
meshB.fillAll(-1)
...
meshE.top_and_tail()
meshE.viewMats()
meshE.save(fname='regolith_square.iSALE',compress=True)
...
meshF.top_and_tail()
meshF.viewMats()
meshF.save(fname='regolith_triangle.iSALE',compress=True)
